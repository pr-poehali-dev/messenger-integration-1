...
interface ProfilePanelProps {
  ...
  phone: string;
  bio?: string;
  onProfileUpdate: (data: { name: string; bio: string; phone: string }) => void;
}

export default function ProfilePanel({ username, phone, bio = '', onProfileUpdate }: ProfilePanelProps) {
